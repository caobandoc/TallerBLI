/*
 * Archivo: T_INTRDADETHAPA_865.java
 * Fecha: 2021-02-05T02:21:07Z
 *
 ...
 * T_INTRDADETHAPA_865 - agregarProducto 
 *
 */
@Path("/INTRD/TLLRB/T_INTRDADETHAPA_865")
@Component
@Service({T_INTRDADETHAPA_865.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=INTRD)(task.submodule=TLLRB)(task.id=T_INTRDADETHAPA_865)(task.version=1.0.0))")
,@Reference(name="VW_AGREGARPDT_468", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_AGREGARPDT_468)(view.version=1.0.0))")
...
public class T_INTRDADETHAPA_865 {
