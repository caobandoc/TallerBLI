 ...
 * T_INTRDUSLLBKMI_804 - CuentaNueva 
 *
 */
@Path("/INTRD/CNTAS/T_INTRDUSLLBKMI_804")
@Component
@Service({T_INTRDUSLLBKMI_804.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=INTRD)(task.submodule=CNTAS)(task.id=T_INTRDUSLLBKMI_804)(task.version=1.0.0))")
,@Reference(name="VW_CUENTANUAV_498", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_CUENTANUAV_498)(view.version=1.0.0))")
,@Reference (name="QV_YQ80_QSS52",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_YQ80_QSS52)")
,@Reference(name="Q_CLIEENNT_KV80",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_CLIEENNT_KV80)(query.version=1.0.0))")
...
public class T_INTRDUSLLBKMI_804 {
