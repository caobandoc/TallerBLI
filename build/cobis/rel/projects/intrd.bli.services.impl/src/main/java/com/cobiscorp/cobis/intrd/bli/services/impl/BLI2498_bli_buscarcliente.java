...
@Properties({
  ...
  @Property(name = "bli.id", value = "BLI2498_bli_buscarcliente")
})
public class BLI2498_bli_buscarcliente implements IBLIExecutor {
  private static final ILogger logger = LogFactory.getLogger(BLI2498_bli_buscarcliente.class);
