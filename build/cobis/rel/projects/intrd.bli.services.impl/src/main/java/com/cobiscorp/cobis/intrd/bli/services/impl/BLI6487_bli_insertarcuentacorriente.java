...
@Properties({
  ...
  @Property(name = "bli.id", value = "BLI6487_bli_insertarcuentacorriente")
})
public class BLI6487_bli_insertarcuentacorriente implements IBLIExecutor {
  private static final ILogger logger = LogFactory.getLogger(BLI6487_bli_insertarcuentacorriente.class);
